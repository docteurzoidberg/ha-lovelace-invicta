...
customElements.define('action-handler-invicta-fontica', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-invicta-fontica')) {
    return body.querySelector('action-handler-invicta-fontica') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-invicta-fontica');
